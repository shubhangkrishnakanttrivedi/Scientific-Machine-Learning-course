...
np.savetxt('vac_2.txt', elec_dens_108_2_vac.detach().numpy())
...
np.savetxt('vac_3.txt', elec_dens_108_3_vac.detach().numpy())
...
np.savetxt('vac_4.txt', elec_dens_108_4_vac.detach().numpy())
...
np.savetxt('vac_5.txt', elec_dens_108_5_vac.detach().numpy())
...
elec_dens_108_out = elec_dens_108_out.view(1,len(list(out_files_108_atoms)),NX_108*NY_108*NZ_108)
elec_dens_108_2 = elec_dens_108_out[0,1,:]
np.savetxt('all_elec_dens_2.txt', elec_dens_108_2.detach().numpy())

elec_dens_108_3 = elec_dens_108_out[0,2,:]
np.savetxt('all_elec_dens_3.txt', elec_dens_108_3.detach().numpy())

elec_dens_108_4 = elec_dens_108_out[0,3,:]
np.savetxt('all_elec_dens_4.txt', elec_dens_108_4.detach().numpy())

elec_dens_108_5 = elec_dens_108_out[0,4,:]
np.savetxt('all_elec_dens_5.txt', elec_dens_108_5.detach().numpy())
